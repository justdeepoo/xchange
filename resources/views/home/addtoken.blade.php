				...
				<div class="col-sm-12 col-md-12">						
					<div class="staric-data addtoken-at">
						<div class="data-details">	
							<h5>Application for adding cryptocurrency/tokens to Xchange</h5>
							<p class="details-disc">If you are the owner, developer or officially representative of the coin/token, you can introduce your coin to Xchange.</p>
    ...
    <div class="col-md-7 col-sm-12">
        <div class="card">
            <header class="card-header token-ad text-center">
                <h4 class="card-title mt-2">Application for adding cryptocurrency/tokens to Xchange</h4>
            </header>
