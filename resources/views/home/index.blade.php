									...
									<div class="modal-content">
										...
										<div class="modal-body">
													...
													<fieldset>
														...
														<div class="form-group">
														<button class="btn btn-global btn-block submit-2fa 2faSubmitBtn">Submit <span><img src="{{asset('/public/gilt/img/btn-arrow.png')}}" /></span></button>
														</div>
													</fieldset>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
											<form class="login-form signup-form" name="reg-form" id="reg-form" >
												...
												<label><input type="checkbox" id="terms" value="1" name="terms"> I agree with the <a href="{{url('/terms-condition')}}" target="_blank">Terms and Conditions</a>.</label>													
											  <br/><br/>
											  <div class="form-group">
...
<section class="section4">
				...
				<div class="col-md-8 col-sm-6">
					<div class="discrip">
						...
						<div class="gilt-extgs">
							<a class="btn btn-global reg-submit" href="#" target="_blank">Read more <span><img src="{{asset('/public/gilt/img/btn-arrow.png')}}"/></span></a>
						</div>
					</div>
				</div>
	...
	@if(Session::get('EMAIL_VERIFICATION_SUCC')=='1' || Session::get('EMAIL_VERIFICATION_ERR')=='1')
            ...
            <div class="modal-dialog">
                <div class="modal-content">
					...
					<div class="modal-body" style="">
						<div>
							@if(Session::get('EMAIL_VERIFICATION_SUCC')=='1')
								{{ Session::forget('EMAIL_VERIFICATION_SUCC')}}
							<div class="form-group destination-t alert alert-success">
								Your email address has been verified successfully.
							</div>
							@elseif(Session::get('EMAIL_VERIFICATION_ERR')=='1')
								{{ Session::forget('EMAIL_VERIFICATION_ERR')}}
							...
							@elseif(Session::get('PASSWORD_RESET_SUCC')=='1')
								{{ Session::forget('PASSWORD_RESET_SUCC')}}
							<div class="form-group destination-t alert alert-danger">
