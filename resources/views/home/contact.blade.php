				...
				<div class="col-sm-12 col-md-6">
					...
					{{ csrf_field() }}
						<div class="newsletter-box">
						  ...
						  <button class="btn btn-global subs-btn btn_global_subsb">SUBSCRIBE <span><img src="{{asset('/public/gilt/img/btn-arrow.png')}}"/></span></button>
						</div>
				...
				{{ csrf_field() }}
					...
					<div class="stayform-s">
						...
						<div class="discover-btn">
							<button type="submit" class="btn btn-global-dark">SEND MESSAGE <span><img src="{{asset('/public/gilt/img/btn-arrow.png')}}"/></span></button>
						</div>
					</div>
					</form>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-4">
					<div class="contact-views">
						<div class="view-details icon-image">
							<img src="{{asset('/public/gilt/img/icon01.png')}}"/>
						</div>
				...
				<div class="col-sm-4">
					<div class="contact-views">
						<div class="view-details icon-image">
							<img src="{{asset('/public/gilt/img/icon02.png')}}"/>
						</div>
						<div class="view-details title">XXXXX</div>
						<div class="view-details discrip">
							<h4>Xchange Global XX.XX</h4>
				...
				<div class="col-sm-4">
					<div class="contact-views">
						<div class="view-details icon-image">
							<img src="{{asset('/public/gilt/img/icon03.png')}}"/>
						</div>
						<div class="view-details title">XXXXX</div>
						<div class="view-details discrip">
							<h4>Xchange Global XX.XX</h4>
