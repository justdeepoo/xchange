					  ...
					  <table class="table table-bordered" id="datatable">
                        ...
                        <?php
                            foreach($coin_list as $k=>$c){
                                ...
                                ?>
                                <tr>
                                <td><i class="cc mmt-icon BTC" title="{{strtoupper($c['coin'])}}"></i> {{strtoupper($c['coin'])}}</td>
                                    <td>{{$c['balance']+$c['in_order']}}</td>
                                    <td class="text-navy"><span>{{$c['in_order']}}</span></td>
                                    <td class="text-navy"><span>{{$c['balance']}}</span></td>
                                    <td>
                                        <div class="actions">
                                            <a href="#" class="deposit-details" data-coin-name="{{$c['coin']}}"  data-coin-qrc="{{$c['qr_code_url']}}"  data-coin-address="{{$address}}" data-dt="{{$dt}}" data-toggle="modal" data-target="#deposit">DEPOSIT</a>
                                            <a href="#" data-toggle="modal" class="withdraw-request" data-coin-name="{{$c['coin']}}" data-coin-bal="{{$c['balance']}}" data-target="#withdraw">WITHDRAW</a>
                                        </div>
                                    </td>
                                </tr>
                            <?php 
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <fieldset>
                        ...
                        <button type="submit" class="btn btn-global confirm-withdraw">Submit <span><img src="{{asset('/public/gilt/img/btn-arrow.png')}}"/></span></button>
