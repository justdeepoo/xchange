						...
						<div class="tab-content">
							<div class="tab-pane fade show active" id="identy" role="tabpanel">														
								<form class="form-inline formindenty" action="#" method="post" name="profile-form" id="profile-form">
									...
									<div class="form-group">
										...
										<input type="text" value="@if(isset($user_data['user']->first_name)){{$user_data['user']->first_name}}@endif" id="first_name" name="first_name" class="form-control">
									</div>
									<div class="form-group">
										<label>Last Name</label>
										<input type="text" value="@if(isset($user_data['user']->last_name)){{$user_data['user']->last_name}}@endif" id="last_name" name="last_name" class="form-control">
                                    </div>
                                    <div class="form-group">
										<label>Mobile</label>
										<input type="text" value="@if(isset($user_data['user']->mobile)){{$user_data['user']->mobile}}@endif" id="mobile" name="mobile"  onkeypress="return isNumberKey(event);" class="form-control">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" value="@if(isset($user_data['user']->document_number)){{$user_data['user']->document_number}}@endif" name="document_number" id="document_number">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label>Colour scan copy of the document</label>
										 <div class="input-group image-preview">
											...
											{?>
												<img src="{{url('/uploads/documents/'.$user_data['user']->document_attached)}}">
											<?php }
											else{
                                             ?>
									...
									{?>
										<div class="discover-btn  marfin-top-tab nobox-shadow ">
											<button type="submit" class="btn btn-global-dark profile-submit-action">SEND FOR VERIFICATION <span><img src="{{asset('/public/gilt/img/btn-arrow.png')}}"/></span></button>
										</div>
									<?php 
										}?>
							...
							<div class="tab-pane fade" id="address" role="tabpanel">
								...
								<h4 class="passvary-s">Verification Address</h4>
									<div class="form-group">
										<label>Address</label>
										<textarea class="form-control"  name="addr" id="addr">@if(isset($user_data['address']->addr)){{$user_data['address']->addr}}@endif</textarea>
									</div>
									<div class="form-group">
										<label>City</label>
										<input type="text" class="form-control" value="@if(isset($user_data['address']->city)){{$user_data['address']->city}}@endif" name="city" id="city">
									</div>
									<div class="form-group">
										<label>Postal Code</label>
										<input type="text" class="form-control" value="@if(isset($user_data['address']->zip_code)){{$user_data['address']->zip_code}}@endif" name="zip_code" id="zip_code" maxlength="8" onkeypress="return isNumberKey(event);" autocomplete="off"> 
									</div>	
									
									<div class="form-group">
										<label>Document Number/Series</label>
										<input type="text" class="form-control" name="document_number" value="@if(isset($user_data['address']->document_number)){{$user_data['address']->document_number}}@endif" value="" id="document_number"> 
									</div>	
								...
								?>
									...
									<div class="form-group">
										...
										<div class="input-group image-preview1">
											...
											{?>
												<img src="{{url('/uploads/documents/'.$user_data['address']->document_attached_file)}}">
											<?php }
											else{?>
									...
									{?>
										<div class="discover-btn  marfin-top-tab nobox-shadow ">
											<button type="submit" class="btn btn-global-dark sub-address">SEND FOR VERIFICATION <span><img src="{{asset('/public/gilt/img/btn-arrow.png')}}"/></span></button>
										</div>
									<?php 
									}?>
							...
							<div class="tab-pane fade" id="bankdetail" role="tabpanel">
								<form class="form-inline formindenty" method="post" action="#"  name="bank-form" id="bank-form">
									...
									<div class="form-group">
										...
										<input type="text" name="bank" value="@if(isset($user_data['bank_account']->account_type)) {{$user_data['bank_account']->bank}} @endif" id='bank' class="form-control">
									</div>
									<div class="form-group">
										<label>Branch Name</label>
										<input type="text" name="branch" value="@if(isset($user_data['bank_account']->branch)){{$user_data['bank_account']->branch}}@endif" id='branch' class="form-control">
									</div>									
									<div class="form-group">
										<label>Account Holder Name</label>
										<input type="text" name="holder_name" value="@if(isset($user_data['bank_account']->holder_name)){{$user_data['bank_account']->holder_name}}@endif" id='holder_name' class="form-control">
									</div>
									<div class="form-group">
										<label>Bank Account Number</label>
										<input type="text" name="account_no" value="@if(isset($user_data['bank_account']->holder_name)){{$user_data['bank_account']->holder_name}}@endif" id="account_no"  class="form-control">
									</div>
									<div class="form-group">
										<label>Re-Enter Bank Account Number</label>
										<input type="text" name="account_no_confirmation" value="@if(isset($user_data['bank_account']->holder_name)){{$user_data['bank_account']->holder_name}}@endif" id="account_no_confirmation"   class="form-control">
									</div>									
									<div class="form-group">
										<label>Pan Card Number</label>
										<input type="text" name="pan_card_number" value="@if(isset($user_data['bank_account']->pan_card_number)){{$user_data['bank_account']->pan_card_number}}@endif" id="pan_card_number"    class="form-control">
									</div>
									<div class="form-group">
										<label>Bank IFSC Code</label>
										<input type="text" name="ifsc" 	value="@if(isset($user_data['bank_account']->ifsc)){{$user_data['bank_account']->ifsc}}@endif" id="ifsc" class="form-control">
									</div>
									<div class="form-group">
										<label>Account Type</label>
										<input type="text" name="account_type" 	value="@if(isset($user_data['bank_account']->account_type)){{$user_data['bank_account']->account_type}}@endif" id="account_type" class="form-control">
									</div>		
									<div class="form-group">
										<label>Mobile Number</label>
										<input type="text" name="linked_mobile" value="@if(isset($user_data['bank_account']->linked_mobile)){{$user_data['bank_account']->linked_mobile}}@endif" id="linked_mobile"  onkeypress="return isNumberKey(event);"  class="form-control">
									</div>	
									<!--
									<div class="form-group">
									...
									<div class="form-group">
										<label>Colour scan copy of the cheque</label>
										 <div class="input-group image-preview">
											...
											{?>
												<img src="{{url('/uploads/documents/'.$user_data['bank_account']->color_scan_cheque)}}">
											<?php }
											else{
                                             ?>
									...
									{?>
									<div class="discover-btn  marfin-top-tab nobox-shadow ">
											<button type="submit" class="btn btn-global-dark sub-bank">SEND FOR VERIFICATION <span><img src="{{asset('/public/gilt/img/btn-arrow.png')}}"/></span></button>
							...
							<div class="tab-pane fade" id="setting" role="tabpanel">
								<form class="form-inline formindenty" action="#" name="reset-password-form" id="reset-password-form">
									...
									<div class="discover-btn  marfin-top-tab nobox-shadow ">
											<button type="submit" class="btn btn-global-dark submit-reset">CHANGE PASSWORD <span><img src="{{asset('/public/gilt/img/btn-arrow.png')}}"/></span></button>
                ...
                <div class="modal-content">
                    ...
                    <form action="#" name="2fa-form" id="2fa-form">
						...
						<div class="modal-header">
							<h4 class="modal-title"> <span class="coin-name"></span> {{($user_data['user']->auth_enabled==0)?'Enable 2FA':'Disabled 2FA'}}</h4>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <fieldset>
                        ...
                        <button type="button" class="btn btn-global psw-submit-2fa">Submit <span><img src="{{asset('/public/gilt/img/btn-arrow.png')}}"/></span></button>
    ...
    <script>
            ...
            $.getJSON("public/countries.json", function (obj) {
                ...
                $.each(obj.Country, function (key, value) {
                    selected = '';
                    if(value.name=="@if(isset($user_data['user']->country)){{$user_data['user']->country}}@endif")
                        selected = 'selected'; 
				...
				$.each(obj.Country, function (key, value) {
                    selected = '';
                    if(value.name=="{{$user_data['address']->country}}")
                        selected = 'selected'; 
					options += ("<option "+selected+" value='" + value.name + "'>" + value.name + "</option>");
                });
