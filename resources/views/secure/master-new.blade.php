...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{asset('/public/wp-content/themes/cryptocurrency-html/assets/css/lib/bootstrap.min.css')}}">
	<!-- Owl Carousel -->
	<link rel="stylesheet" type="text/css" href="{{asset('/public/wp-content/themes/cryptocurrency-html/assets/css/lib/owl.carousel.min.css')}}">
	<!-- Slick Carousel -->
	<link rel="stylesheet" type="text/css" href="{{asset('/public/wp-content/themes/cryptocurrency-html/assets/css/lib/slick.css')}}">
	<!-- Animation -->
	<link rel="stylesheet" type="text/css" href="{{asset('/public/wp-content/themes/cryptocurrency-html/assets/css/lib/animations.min.css')}}">
	<!-- Google Font -->
	<link href="https://fonts.googleapis.com/css?family=Muli:300,400,400i,600,700,700i,800,900" rel="stylesheet">
	<!-- Style Theme -->
	<link rel="stylesheet" type="text/css" href="{{asset('/public/wp-content/themes/cryptocurrency-html/assets/css/style.css')}}">
	<!-- Responsive Theme -->
	<link rel="stylesheet" type="text/css" href="{{asset('/public/wp-content/themes/cryptocurrency-html/assets/css/responsive.css')}}">
	<!-- Style Straight Theme -->
    <link rel="stylesheet" type="text/css" href="{{asset('/public/wp-content/themes/cryptocurrency-html/assets/css/style-straight.css')}}">
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-xl-3 col-lg-3 col-md-12">
					<a href="{{url('/')}}">
						<img src="{{asset('/public/wp-content/themes/cryptocurrency-html/assets/img/logo-s.png')}}" class="logo" alt="images">
					</a>
				</div>
				<div class="col-xl-9 col-lg-9 col-md-12 text-right">
					...
					<div class="header-block">
						<ul id="accordion"  class="nav-menu list-unstyled list-inline">
							...
							<li class="list-inline-item"  ><a href="{{url('/about')}}"><strong>Exchange<span>-</span></strong></a></li> -->
						...
						<div class="text-center">
							<a href="{{url('/secure/login')}}" class="blue-brd-btn">Sign In</a>
							<a href="{{url('/secure/register')}}" class="blue-brd-btn">Sign Up</a>
						</div>
...
<script src="{{asset('/public/wp-content/themes/cryptocurrency-html/assets/js/lib/popper.min.js')}}"></script>
<script src="{{asset('/public/wp-content/themes/cryptocurrency-html/assets/js/lib/bootstrap.min.js')}}"></script>
<script src="{{asset('/public/wp-content/themes/cryptocurrency-html/assets/js/lib/owl.carousel.min.js')}}"></script>
<script src="{{asset('/public/wp-content/themes/cryptocurrency-html/assets/js/lib/masonry.pkgd.min.js')}}"></script>
<script src="{{asset('/public/wp-content/themes/cryptocurrency-html/assets/js/lib/slick.min.js')}}"></script>
<script src="{{asset('/public/wp-content/themes/cryptocurrency-html/assets/js/lib/css3-animate-it.js')}}"></script>
<script src="{{asset('/public/wp-content/themes/cryptocurrency-html/assets/js/main.js')}}"></script>
