					...
					<div class="table-responsive dash-table-markets no-heights">
						<table class="table">
							...
							<tbody>
								<tr>
									<td>
									<?php echo e(number_format($balance->balance+$balance->locked_bal,2)); ?> <?php echo e(strtoupper($balance->coin)); ?></td>
									<td><?php echo e(number_format($balance->locked_bal,2)); ?> <?php echo e(strtoupper($balance->coin)); ?></td>
									<td>
									<?php echo e(number_format($balance->balance,2)); ?> <?php echo e(strtoupper($balance->coin)); ?></td>
									<td>
						...
						<table class="table">							
							...
							<tbody>
								...
								?>
										...
										<tr>
											<td><?php echo e($v->amount); ?> INR</td>
											<td><?php echo e(date('M-d, Y', strtotime($v->deposit_date))); ?></td>
											<td><?php echo e($v->reference_number); ?></td>
											<td><?php echo $status; ?></td>
											<!--<td>
											<?php 
												//if($v->status == 0){ 
											?>
											<a href="javascript:void(0);" data-toggle="modal"  data-target="#del-deposit-req-modal" onclick="delDepositReq('<?php echo e($v->id); ?>');" >Delete</a>
											<?php 
												//}
											?>
											</td>-->
								...
								<?php 
										...
										echo '<tr><td colspan="5">No deposit request!</td></tr>';
									}
								?>
							</tbody>
						</table>						
						...
						<table class="table">							
							...
							<tbody>
								...
								?>
										...
										<tr>
											<td><?php echo e($v->amount); ?> INR</td>
											<td><?php echo e(date('M-d, Y', strtotime($v->reqeusted_at))); ?></td>		<td><?php echo $status; ?></td>	
											<!-- <td>
												<?php 
													//if($v->status == 0){ 
												?>
												<a href="javascript:void(0);" data-toggle="modal"  data-target="#del-withdraw-req-modal" onclick="delWithdrawReq('<?php echo e($v->id); ?>');" >Delete</a>
												<?php //} ?>
											</td> -->
										</tr>
								<?php 
										...
										echo '<tr><td colspan="4">No withdrawal request!</td></tr>';
									}
								?>
							</tbody>
						</table>						
