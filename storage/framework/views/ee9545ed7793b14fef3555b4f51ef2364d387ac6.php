					...
					<div class="headerform-main">
						<div class="header-content">
							...
							<div class="discription">
								Exchange makes it safe and easy to Buy, Sell and Trade in Digital Currencies like Bitcoin and Ethereum 
								
							</div>
							<!--<div class="discover-btn">
								<button type="button" class="btn btn-global-dark">discover ICO <span><img src="<?php echo e(asset('/public/gilt/img/btn-arrow.png')); ?>"/></span></button>
							</div>-->
						</div>
								...
								<div class="form-wrap">
									...
									<form role="form" name="login-form" id="login-form" autocomplete="off">
										<div class="form-group">											
											<input type="text" class="form-control login-email-input" name="email" id="email" placeholder="Email address" autocomplete="off">
										</div>
										<div class="form-group">											
										...
										<div class="login-btn">
											<button type="submit" class="btn btn-global login-submit">LOG IN<span><img src="<?php echo e(asset('/public/gilt/img/btn-arrow.png')); ?>"/></span></button>
										</div>
										...
										<div class="modal-body">
													...
													<fieldset>
														...
														<div class="input-group">
															...
															<input id="2fa-code" placeholder="2FA" name="2fa-code" class="form-control index-2fa-code" type="text" onkeypress="return isNumberKeyFront(event);" onkeyup="return submit2Fa();" autocomplete="off" >
														</div>
														</div>
														<div class="form-group">
														<button class="btn btn-global btn-block submit-2fa 2faSubmitBtn">Submit <span><img src="<?php echo e(asset('/public/gilt/img/btn-arrow.png')); ?>" /></span></button>
														</div>
													</fieldset>
									...
									<div class="modal-content">
										...
										<div class="modal-body">
												...
												<fieldset>
													...
													<div class="form-group">
													<button class="btn btn-global btn-block forgot-sub">Submit <span><img src="<?php echo e(asset('/public/gilt/img/btn-arrow.png')); ?>"/></span></button>
													</div>
												</fieldset>
												</form>
										</div>
								...
								<div id="signup" class="modal fade" role="dialog">
									...
									<div class="modal-content">
										<div class="modal-header">
											...
											<button type="button" class="close signup-close" data-dismiss="modal">&times;</button>
										</div>
										<div class="modal-body">
											<form class="login-form signup-form" name="reg-form" id="reg-form" >
												...
												<label><input type="checkbox" id="terms" value="1" name="terms"> I agree with the <a href="<?php echo e(url('/terms-condition')); ?>" target="_blank">Terms and Conditions</a>.</label>													
											  <br/><br/>
											  <div class="form-group">
												<button class="btn btn-global btn-block reg-submit">SIGN UP <span><img src="<?php echo e(asset('/public/gilt/img/btn-arrow.png')); ?>"/></span></button>
											  </div>												
											</form>
											<div class="signup-msg-ara"></div>
										</div>
...
<section class="section4">
    ...
    <section class="bestbit-2">
      <div class="container">
			...
			<h3 class="sec-title">X TOKEN</h3>
				<!--<div class="lunch">Launching Soon</div>-->
				<div class="row">
				<div class="col-md-8 col-sm-6">
					<div class="discrip">
						<p>X token (X) is available with a single purpose i.e everlasting success of a staging or a
						belvedere as it is devoted towards its users in terms of its service or driving action. </p>
						<ul class="point-list">
							<li>Bring home X tokens for trading on Exchange</li>
							<li>Utilize X Token to pay for trading</li>
							<li>Exchange Offers you 50% off on your trading fee.</li>
							<li>Indeed Trade X on exchange.</li>
						</ul>
						<div class="gilt-extgs">
							<a class="btn btn-global reg-submit" href="#" target="_blank">Read more <span><img src="<?php echo e(asset('/public/gilt/img/btn-arrow.png')); ?>"/></span></a>
						</div>
					</div>
				</div>
				<div class="col-md-4 col-sm-6">
					<!--<div class="gxlo-img">
						<img src="<?php echo e(asset('/public/gilt/img/GXLOGOCOIN2.png')); ?>"/>
					</div>-->
					<div class="gxlo-img">
						<img src="<?php echo e(asset('/public/gilt/img/GILTXCOIN.png')); ?>"/>
					</div>
				</div>
			</div>
	...
	<?php if(Session::get('EMAIL_VERIFICATION_SUCC')=='1' || Session::get('EMAIL_VERIFICATION_ERR')=='1'): ?>
	<!--  Email Verification Modal (start) -->
    <div class="deposit-inr-request">        
        <div class="modal inmodal" id="email-verify-msg-modal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
					...
					<div class="modal-body" style="">
						<div>
							<?php if(Session::get('EMAIL_VERIFICATION_SUCC')=='1'): ?>
								<?php echo e(Session::forget('EMAIL_VERIFICATION_SUCC')); ?>

							<div class="form-group destination-t alert alert-success">
								Your email address has been verified successfully.
							</div>
							<?php elseif(Session::get('EMAIL_VERIFICATION_ERR')=='1'): ?>
								<?php echo e(Session::forget('EMAIL_VERIFICATION_ERR')); ?>

							<div class="form-group destination-t alert alert-danger">
								You have already verified your email address or your token has been expired/invalid.
							</div>
							<?php elseif(Session::get('PASSWORD_RESET_SUCC')=='1'): ?>
								<?php echo e(Session::forget('PASSWORD_RESET_SUCC')); ?>
	...
	<script>
	setTimeout(function(){		
		$('#email-verify-msg-modal').modal('show');
	}, 1000);
	</script>	
	<?php endif; ?>
