								...
								<div class="dash-table-markets no-padding table-responsive">
									...
									<tbody>
										<?php
											...
											{?>
												<tr>
													<td><p class="text-muted no-margin"><a href="<?php echo e(url('/trade/btc-'.$coin->pair_coin)); ?>"><?php echo e(strtoupper($coin->pair_coin)); ?>/BTC</a></p></td>
													<td><p class="no-margin"><span></span> <?php echo e(number_format($coin->rate,4)); ?></p></td>
								...
								<div class="dash-table-markets">
									...
									<tbody>
										<?php
											...
											{?>
												<tr>
													<td><p class="text-muted no-margin"><a href="<?php echo e(url('/trade/eth-'.$coin->pair_coin)); ?>"><?php echo e(strtoupper($coin->pair_coin)); ?>/ETH</a></p></td>
													<td><p class="no-margin"><span></span> <?php echo e(number_format($coin->rate,4)); ?></p></td>
													<td class="no-wrap"><span class="change-down color-red label label-light-danger"><i class="fa fa-chevron-down"></i> -15.20%</span></td>
												</tr>
										<?php	
								...
								<table id="data-tables-market" class="table table-cryptic <!--dataTable--> no-footer"> <!--data-page-length="10"-->
									...
									<tbody>
										<?php
											...
											{?>
												<tr>
													<td><p class="text-muted no-margin"><a href="<?php echo e(url('/trade/inr-'.$coin->pair_coin)); ?>"><?php echo e(strtoupper($coin->pair_coin)); ?>/INR</a></p></td>
													<td><p class="no-margin"><span></span> <?php echo e(number_format($coin->rate,4)); ?></p></td>
													<td class="no-wrap"><span class="change-down color-red label label-light-danger"><i class="fa fa-chevron-down"></i> -15.20%</span></td>
												</tr>
										<?php	
										...
										<h3>Buy <?php echo e(strtoupper($to_currency)); ?></h3>
											<form action="#" name="buy-form" id="buy-form" autocomplete="off">
												<ul class="clearfix">
													<li>
														...
														<span class="btc-span" id="buyVolSpan">
															<input type="text" name="vol" value=""  class="form-control cust-inp only-int buy-input buyVol" id="vol" onkeypress="hideErrMsg();" />	
													...
													<li>
														...
														<span class="btc-span" id="buyAtSpan" >
															<input type="text" name="at" value="" class="form-control cust-inp only-int buy-input buyAt" id="at"/>	
												...
												<div class="discover-btn no-shadow-s clearfix">
													<button type="submit" class="btn btn-global-dark buy buy-btn">Buy <?php echo e(strtoupper($from_currency)); ?> <span><img src="<?php echo e(asset('/public/gilt/img/btn-arrow.png')); ?>"/></span></button>
												</div>
												...
												<ul class="clearfix">
													<li>
														...
														<span class="btc-span" id="sellVolSpan" >
															<input type="text" name="vol"  class="form-control cust-inp only-int sell-input sellVol" id="vol"/>	
															<span class="btc-right"><?php echo e(strtoupper($to_currency)); ?></span>	
														</span>
													</li>
													<li>
														...
														<span class="btc-span" id="sellAtSpan" >
															<input type="text" name="at" class="form-control cust-inp only-int sell-input sellAt" id="at" />	
															<span class="btc-right"><?php echo e(strtoupper($from_currency)); ?></span>	
														</span>
													</li>
													<li>
...
<?php $__env->startSection('footerjs'); ?>
    ...
    <script>
        node_server_point = '<?php echo e(env('node_server_point')); ?>';
    </script>
    <script src="<?php echo e(env('node_server_point')); ?>/socket.io/socket.io.js"></script>
