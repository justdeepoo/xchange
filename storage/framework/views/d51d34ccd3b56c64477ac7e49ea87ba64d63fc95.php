			...
			<div class="row">
				<div class="col-sm-12 col-md-12">
					...
					<div class="discover-btn nobox-shadow">
						<button type="button" class="btn btn-global-dark">DISCOVER DOOM<span><img src="<?php echo e(asset('/public/gilt/img/btn-arrow.png')); ?>"/></span></button>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
					...
					<div class="team-member">
						<div class="team-view">
							<div class="team-image">
								<img src="<?php echo e(asset('/public/gilt/img/01.jpg')); ?>"/>
							</div>
						</div>
						<div class="team-view">
				...
				<div class="col-sm-12 col-md-3">
					<div class="team-member">
						<div class="team-view">
							<div class="team-image">
								<img src="<?php echo e(asset('/public/gilt/img/02.jpg')); ?>"/>
							</div>
						</div>
						<div class="team-view">
							<div class="team-details">
				...
				<div class="col-sm-12 col-md-3">
					<div class="team-member">
						<div class="team-view">
							<div class="team-image">
								<img src="<?php echo e(asset('/public/gilt/img/03.jpg')); ?>"/>
							</div>
						</div>
						<div class="team-view">
							<div class="team-details">
				...
				<div class="col-sm-12 col-md-3">
					<div class="team-member">
						<div class="team-view">
							<div class="team-image">
								<img src="<?php echo e(asset('/public/gilt/img/04.jpg')); ?>"/>
							</div>
						</div>
						<div class="team-view">
							<div class="team-details">
			...
			<div class="row">
					...
					<div class="team-member">
						<div class="team-view">
							<div class="teampoint-image">
								<img src="<?php echo e(asset('/public/gilt/img/icon05.png')); ?>"/>
							</div>
						</div>
						<div class="team-view">
				...
				<div class="col-sm-12 col-md-3">
					<div class="team-member">
						<div class="team-view">
							<div class="teampoint-image">
								<img src="<?php echo e(asset('/public/gilt/img/icon06.png')); ?>"/>
							</div>
						</div>
						<div class="team-view">
							<div class="teampoint-details">
				...
				<div class="col-sm-12 col-md-3">
					<div class="team-member">
						<div class="team-view">
							<div class="teampoint-image">
								<img src="<?php echo e(asset('/public/gilt/img/icon07.png')); ?>"/>
							</div>
						</div>
						<div class="team-view">
							<div class="teampoint-details">
				...
				<div class="col-sm-12 col-md-3">
					<div class="team-member">
						<div class="team-view">
							<div class="teampoint-image">
								<img src="<?php echo e(asset('/public/gilt/img/icon08.png')); ?>"/>
							</div>
						</div>
						<div class="team-view">
							<div class="teampoint-details">
							...
							<div class="carousel-inner" role="listbox">
							  <div class="carousel-item">							
									<div class="testmor-image view-testi">
										<img src="<?php echo e(asset('/public/gilt/img/05.jpg')); ?>"/>
									</div>
							  ...
							  <div class="carousel-item">							
									<div class="testmor-image view-testi">
										<img src="<?php echo e(asset('/public/gilt/img/06.jpg')); ?>"/>
									</div>
									<div class="testimg-discrip view-testi">
										<h4>Daiane Smith, <span>Customer</span></h4>
										<p>Etiam nec odio vestibulum est mattis effic iturut magna. Pellentesque sit amet tellus blandit. Etiam nec odio vestibulum est mattis effic iturut magna. Pellentesque sit am et tellus blandit. Etiam nec odio vestibul. Etiam nec odio vestibulum est mat tis effic iturut magna.</p>
							  ...
							  <div class="carousel-item active">							
									<div class="testmor-image view-testi">
										<img src="<?php echo e(asset('/public/gilt/img/07.jpg')); ?>"/>
									</div>
									<div class="testimg-discrip view-testi">
										<h4>Daiane Smith, <span>Customer</span></h4>
										<p>Etiam nec odio vestibulum est mattis effic iturut magna. Pellentesque sit amet tellus blandit. Etiam nec odio vestibulum est mattis effic iturut magna. Pellentesque sit am et tellus blandit. Etiam nec odio vestibul. Etiam nec odio vestibulum est mat tis effic iturut magna.</p>
	...
	<section class="faqpage">
		<div class="container">
			...
			<div class="discover-btn nobox-shadow text-center">
				<button type="button" class="btn btn-global-dark">SEE ALL FAQ<span><img src="<?php echo e(asset('/public/gilt/img/btn-arrow.png')); ?>"/></span></button>
			</div>
		</div>
	</section>
<?php $__env->stopSection(); ?>
