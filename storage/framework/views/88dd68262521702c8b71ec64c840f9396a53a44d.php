...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-119115552-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-119115552-1');
</script>
<meta name="google-site-verification" content="j4rGQlPySvH7i1VLiek3EPkfu_jpaiUULf7nBex-KM0" />
</head>
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-darkblue fixed-top header-menu">
      <div class="container">
		...
		<ul class="navbar-nav ml-auto logo-menu">
            <?php if(Session::get('sess_userfname')!=''): ?>
    ...
    <footer class="dark-footer">
      <div class="container">
		...
		<div class="col-sm-12 col-md-3">
				<div class="abloutftr">
				<a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset('/public/gilt/img/footerlogo.png')); ?>"/></a>
					<!--<p>
    ...
    <script src="<?php echo e(asset('/public/gilt/vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
		<script src="<?php echo e(asset('/public/gilt/js/secure.js')); ?>"></script>
